package com.yzh666.careerai.modules.voiceinterview.repository;

import com.yzh666.careerai.modules.voiceinterview.model.VoiceInterviewSessionEntity;
import com.yzh666.careerai.modules.voiceinterview.model.VoiceInterviewSessionEntity.InterviewPhase;
...
public interface VoiceInterviewSessionRepository extends JpaRepository<VoiceInterviewSessionEntity, Long> {
    ...
    Optional<VoiceInterviewSessionEntity> findByStatusAndEndTimeBefore(
        com.yzh666.careerai.common.model.AsyncTaskStatus status,
        LocalDateTime time
    );
    ...
    List<VoiceInterviewSessionEntity> findByEvaluateStatusAndUpdatedAtBefore(
        com.yzh666.careerai.common.model.AsyncTaskStatus evaluateStatus,
        LocalDateTime time
    );
}
