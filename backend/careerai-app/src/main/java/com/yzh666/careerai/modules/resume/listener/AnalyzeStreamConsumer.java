package com.yzh666.careerai.modules.resume.listener;
...
import com.yzh666.careerai.modules.resume.service.ResumeGradingService;
 ...
 */
@Slf4j
@ConditionalOnProperty(prefix = "app.redis-stream.analyze", name = "consumer-enabled", havingValue = "true", matchIfMissing = true)
@Component
