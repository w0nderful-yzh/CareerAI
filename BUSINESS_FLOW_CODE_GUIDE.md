...
>
> 本文已按当前精简后的代码重新核对；已删除的面试预约、系统健康代理和无前端入口接口不再属于主业务阅读范围。
...
> Python Agent 负责非确定性的规划、跨领域决策和流程状态；Java 领域服务负责业务事实、权限、幂等、事务，以及与领域结果强绑定的 AI 执行；Knowledge Service 负责检索、向量化和 RAG。
...
| `backend/knowledge-service` | Spring Boot + Spring AI + pgvector | 知识库、Embedding、向量检索和 RAG |

`backend/careerai-shared` 是上述 Java 模块复用的代码库，不是需要单独启动的微服务。Knowledge Service 是真实运行模块，但不是本文两条默认主链路的中心。
...
- [RunService.create_run](agent-service/src/careerai_agent/services/runs.py#L25)
- [RunService.resume_run](agent-service/src/careerai_agent/services/runs.py#L66)
- [使用 run_id 作为 LangGraph thread_id](agent-service/src/careerai_agent/services/runs.py#L86)
...
- [build_graph](agent-service/src/careerai_agent/graph/builder.py#L31)
- [图节点和边](agent-service/src/careerai_agent/graph/builder.py#L371)
...
- [初始化计划](agent-service/src/careerai_agent/graph/builder.py#L48)
- [加载简历和岗位上下文](agent-service/src/careerai_agent/graph/builder.py#L61)
- [创建岗位匹配任务](agent-service/src/careerai_agent/graph/builder.py#L123)
- [轮询异步任务](agent-service/src/careerai_agent/graph/builder.py#L161)
- [生成准备策略](agent-service/src/careerai_agent/graph/builder.py#L283)
- [创建改进计划](agent-service/src/careerai_agent/graph/builder.py#L227)

当前 Planner 会调用模型生成展示用的五步标题，但提示词已经把五个业务阶段写死：

- [LangChainAgentPlanner](agent-service/src/careerai_agent/services/planner.py#L20)

因此真正决定执行顺序的是 `builder.py` 的固定图，而不是模型输出。阅读时要把 Planner 理解成“计划文案生成器”，不是开放式任务规划器；这次模型调用后续可以直接改成确定性代码，减少延迟、Token 和格式失败风险。
...
- [JobMatchTaskService.createTask](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchTaskService.java#L40)
- [幂等创建任务](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchTaskService.java#L45)
...
- [处理任务消息](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/messaging/JobMatchRabbitListener.java#L53)
...
- [JobMatchService](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L42)
- [执行一次匹配](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L112)
- [构造模型分析](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L191)
...
- [JobMatchService.COVERAGE_TYPES](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L46)
...
- [normalizeEvidenceMappings](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L273)
...
- [poll_job_match 中进入 WAITING_ASYNC](agent-service/src/careerai_agent/graph/builder.py#L161)
...
- [准备决策节点](agent-service/src/careerai_agent/graph/builder.py#L283)
- [PreparationAction 和 PreparationStrategy](agent-service/src/careerai_agent/services/decision.py#L19)
- [LangChainPreparationDecisionMaker](agent-service/src/careerai_agent/services/decision.py#L67)
...
- [ResumeImprovementPlanService](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L48)
- [Agent 幂等创建入口](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L133)
...
- [findLatestJobEvaluation](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L252)

Agent 决策也会被写进模型上下文：

- [buildAgentDecisionContext](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L289)
...
- [normalizePreparationTasks](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L344)
...
- [加载规划上下文](agent-service/src/careerai_agent/graph/interview_creation.py#L51)
- [生成面试蓝图](agent-service/src/careerai_agent/graph/interview_creation.py#L80)
- [创建 Java Session](agent-service/src/careerai_agent/graph/interview_creation.py#L93)
- [创建图的节点和边](agent-service/src/careerai_agent/graph/interview_creation.py#L124)
...
- [InterviewBlueprintPlanner.plan](agent-service/src/careerai_agent/services/blueprint.py#L50)
- [蓝图提示词](agent-service/src/careerai_agent/services/blueprint.py#L89)
- [蓝图归一化](agent-service/src/careerai_agent/services/blueprint.py#L131)
- [从历史能力中选择复测主题](agent-service/src/careerai_agent/services/blueprint.py#L189)
...
- [加载 Turn Context](agent-service/src/careerai_agent/graph/interview.py#L46)
- [模型决策](agent-service/src/careerai_agent/graph/interview.py#L57)
- [应用决策](agent-service/src/careerai_agent/graph/interview.py#L64)
...
- [stream_turn](agent-service/src/careerai_agent/graph/interview.py#L175)
...
- [LangChainInterviewDecisionMaker.decide](agent-service/src/careerai_agent/services/interview.py#L128)
...
- [validateNextQuestionIntent](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L546)

回答评价校验：

- [validateTurnEvaluation](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L671)
...
- [InterviewSessionService.generateNextQuestion](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L617)
...
- [辅助分支](agent-service/src/careerai_agent/graph/interview.py#L185)
- [assist_stream](agent-service/src/careerai_agent/services/interview.py#L186)
...
- [_apply_control](agent-service/src/careerai_agent/graph/interview.py#L303)

Java 中走控制 Turn，而不是正式评分 Turn：

- [InterviewSessionService.applyControlTurn](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L420)
...
- [abilityProfileService.recordTurn 调用点](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L365)
...
- [InterviewSessionService.finishInterview](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L853)

统一完成逻辑：

- [completeSession](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L801)
...
- [消费者保存报告并触发收口](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/listener/EvaluateStreamConsumer.java#L152)
...
- [历史重点选择](agent-service/src/careerai_agent/services/blueprint.py#L189)
...
- [ResumeImprovementPlanService.findLatestJobEvaluation](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L252)
...
- [JobMatchTaskService.createTaskIdempotently](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchTaskService.java#L45)

### 改进计划层

- [ResumeImprovementPlanService.createPlanIdempotently](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L133)
...
这些模型调用没有集中在一种语言里：准备策略、面试蓝图和单轮面试决策在 Python；简历分析、JD 解析、岗位匹配、具体题目、改进计划和整场报告主要在 Java；RAG 回答和查询改写在 Knowledge Service。
...
划分依据不是“只要用了大模型就放 Python”，而是“谁拥有输入事实、业务约束和最终结果”。Python 更适合跨领域决策和可恢复编排；与单一领域数据、校验和持久化紧密绑定的生成留在 Java，能避免跨服务传输大段简历/JD、重复 DTO 和分布式补偿。
...
1. [Career Agent 图](agent-service/src/careerai_agent/graph/builder.py#L48)
2. [RunService](agent-service/src/careerai_agent/services/runs.py#L25)
3. [LangChainAgentPlanner](agent-service/src/careerai_agent/services/planner.py#L20)
4. [LangChainPreparationDecisionMaker](agent-service/src/careerai_agent/services/decision.py#L67)
5. [JobMatchTaskService](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchTaskService.java#L45)
6. [JobMatchService](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/service/JobMatchService.java#L112)
7. [ResumeImprovementPlanService](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/resumeplan/service/ResumeImprovementPlanService.java#L133)
...
2. [Blueprint Planner](agent-service/src/careerai_agent/services/blueprint.py#L50)
3. [Interview Turn 图](agent-service/src/careerai_agent/graph/interview.py#L35)
4. [LangChainInterviewDecisionMaker](agent-service/src/careerai_agent/services/interview.py#L128)
...
5. [Blueprint 的历史重点算法](agent-service/src/careerai_agent/services/blueprint.py#L189)
...
2. [JobMatchRabbitListener](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/messaging/JobMatchRabbitListener.java#L53)
...
2. [poll_job_match](agent-service/src/careerai_agent/graph/builder.py#L161) 查询到的任务状态是什么。
...
4. [JobMatchRabbitListener](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/jobmatch/messaging/JobMatchRabbitListener.java#L53) 是否处理。
...
2. [Java NextQuestionIntent 校验](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L546)
...
1. 是否至少存在一个正式回答。
2. [finishInterview](backend/careerai-app/src/main/java/com/yzh666/careerai/modules/interview/service/InterviewSessionService.java#L853) 是否投递评估任务。
...
### 12.8 AI 能力不是全部由 Python 实现

Python 是 Agent 编排和策略层，不是项目唯一的 AI 运行时。`careerai-app` 仍直接执行大部分领域生成，`knowledge-service` 独立执行向量检索和 RAG。当前边界的重点是让 Python 决定“下一步做什么”，Java 决定“这个业务动作是否合法并如何形成可查询结果”。
